          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Description / Purpose',
                    style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 14,
                        color: Color(0xFF09090B))),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    hintText:
                        'e.g. Travel allowance for outlet visits in Sector 4',
                    border: OutlineInputBorder(),
                  ),
                ),
                const SizedBox(height: 16),
                const Text('Receipt Image Proof',
                    style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 14,
                        color: Color(0xFF09090B))),
              ...
              data: (items) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, i) {
                    final exp = items[i];
                    final cat =
                        (exp['category'] ?? 'misc').toString().toUpperCase();
                    final status =
                        (exp['status'] ?? 'submitted').toString().toUpperCase();
                    final expDateStr = DateFormatter.formatDate(
                        DateTime.parse(exp['expense_date']));
