...
class DashboardTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final attendance =
        attendanceAsync.valueOrNull ?? AttendanceState.notCheckedIn();
                        ...
                        Column(
                          ...
                          children: [
                            userAsync.when(
                              ...
                              loading: () => const Text('Hi, Sales Rep',
                                  style: TextStyle(
                                      color: Color(0xFF09090B),
                                      fontWeight: FontWeight.bold,
                                      fontSize: 19)),
                              error: (_, __) => const Text('Hi, Sales Rep',
                                  style: TextStyle(
                                      color: Color(0xFF09090B),
                                      fontWeight: FontWeight.bold,
                                      fontSize: 19)),
                              ...
                              child: Row(
                                ...
                                children: [
                                  const Icon(Icons.calendar_today_rounded,
                                      size: 10, color: Color(0xFF71717A)),
                      ...
                      return Column(
                        ...
                        children: [
                            ...
                            children: [
                              Expanded(
                                child: _buildActionTile(
                                  ...
                                  isDark: isCheckedIn,
                                  onTap: () =>
                                      _showStartRetailingDrawer(context, ref),
                                ),
                              ),
                              const SizedBox(width: 12),
                              Expanded(
                          ...
                          _buildActionCard(
                            ...
                            description:
                                'Book primary distributor & channel partner order.',
                      ...
                      children: [
                        ...
                        if (user?.role == 'vendor_admin')
                          _buildActionTile(
                            ...
                            isDark: isCheckedIn,
                            onTap: () =>
                                context.push('/procurement/vendor-admin'),
                          ),
                        if (user?.role == 'vendor_technician')
                          _buildActionTile(
                            ...
                            isDark: isCheckedIn,
                            onTap: () =>
                                context.push('/procurement/vendor-tech'),
                          ),
                      ],
                    );
                  },
                            ...
                            try {
                              ...
                              if (ctx.mounted) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                        'Workday shift started successfully!'),
                              ...
                              if (ctx.mounted) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                        'Failed to check in: ${e.toString().replaceAll('Exception:', '')}'),
                                    backgroundColor: const Color(0xFFDC2626),
                                    behavior: SnackBarBehavior.floating,
                                  ),
                                );
            ...
            children: [
              Container(
                ...
                child: Icon(
                  ...
                  color: isDark
                      ? Colors.white
                      : (isPrimary ? Colors.white : const Color(0xFF09090B)),
                  size: 20,
                ),
              ),
              const SizedBox(width: 12),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color:
                    isDark ? const Color(0x1F000000) : const Color(0x04000000),
                blurRadius: 6,
                offset: const Offset(0, 2),
              ),
            ],
...
class _StartRetailingBottomSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_StartRetailingBottomSheet> createState() =>
      _StartRetailingBottomSheetState();
}

class _StartRetailingBottomSheetState
    extends ConsumerState<_StartRetailingBottomSheet> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                  icon:
                      const Icon(Icons.close_rounded, color: Color(0xFF71717A)),
            ...
            child: beatsAsync.when(
              data: (beats) {
                final filtered = beats.where((b) {
                  ...
                  final posMatch = (b.l1PositionName ?? '')
                      .toLowerCase()
                      .contains(_searchQuery);
                  final userMatch = (b.assignedUserName ?? '')
                      .toLowerCase()
                      .contains(_searchQuery);
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (ctx, i) {
                    ...
                    return Material(
                      ...
                      child: InkWell(
                        onTap: () {
                          ref.read(selectedBeatIdProvider.notifier).state =
                              beat.id;
                          Navigator.pop(ctx);
                          context.push('/beat');
                        },
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 10),
                              const Divider(
                                  height: 1, color: Color(0xFFF4F4F5)),
                              const SizedBox(height: 8),
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                  ...
                                  const Row(
                                    children: [
                                      ...
                                      Icon(Icons.arrow_forward_ios_rounded,
                                          size: 12, color: Color(0xFF09090B)),
                                    ],
                                  ),
                                ],
                              ),
